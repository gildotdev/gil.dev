...
function Pinboard_Linkroll() {
  ...
  this.format_item = function(it) {
    ...
    if (it.n) {
      str += "<br /><span class=\"pin-description\">" + this.cook(it.n) + "</span>\n";
    }
    if (it.t.length > 0) {
...
pinboardNS_fetch_script("https://feeds.pinboard.in/json/v1/u:"+pinboard_user+"/t:@blog/?cb=pinboardNS_show_bmarks\&count="+pinboard_count);
